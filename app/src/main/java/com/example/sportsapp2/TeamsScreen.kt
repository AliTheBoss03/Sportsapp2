...
class TeamsScreen : AppCompatActivity() {
    ...
    private fun redirectToMainScreen() {
        val intent = Intent(this@TeamsScreen, MainActivity::class.java)
        startActivity(intent)
    }

    private fun redirectToSearch() {
        val intent = Intent(this@TeamsScreen, SettingsScreen::class.java)
        startActivity(intent)
    }

    private fun redirectToSettings() {
        val intent = Intent(this@TeamsScreen, SearchBarScreen::class.java)
        startActivity(intent)
    }
}